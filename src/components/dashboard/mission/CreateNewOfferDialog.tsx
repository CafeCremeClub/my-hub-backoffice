...
const CreateNewOfferDialog = ({isOpen, onClose}: CreateNewOfferDialogProps) => {
    ...
    const formik = useFormik<CreateMissionPayload>({
        ...
        onSubmit: async (values) => {
            try {
                ...
                console.log(error);
                setError("Une erreur est survenue lors de la création de l'offre. Veuillez réessayer plus tard.");
            }
        }
    });
            ...
            <DialogContent className="sm:max-w-2xl overflow-hidden rounded-[1.25rem] h-[90vh]">
                <div className="bg-white flex flex-col gap-6 overflow-y-auto scroll-hidden">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Remplissez les informations ci-dessous pour créer une nouvelle offre de mission.
                        </DialogDescription>
                    </DialogHeader>
                    ...
                    <form onSubmit={formik.handleSubmit} className="flex flex-col gap-6 px-2">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <CustomTextarea
                                ...
                                onChange={formik.handleChange}
                                onBlur={formik.handleBlur}
                                isError={formik.touched.companyBio && !!formik.errors.companyBio}
                                rows={4}
                            />
                            {formik.touched.companyBio && formik.errors.companyBio && (
                                <CustomErrorIndicator
                                    message={formik.errors.companyBio}
                                />
                            )}
                        </div>
