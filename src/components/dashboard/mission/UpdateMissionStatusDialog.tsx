    ...
    const formik = useFormik<FormValues>({
        ...
        onSubmit: async (values) => {
            try {
                ...
                console.log(error);
                setError("Une erreur est survenue lors de la mise à jour du statut de la mission. Veuillez réessayer plus tard.");
            }
        }
    });
            ...
            <DialogContent className="sm:max-w-lg overflow-hidden rounded-[1.25rem]">
                <div className="bg-white flex flex-col gap-10 overflow-y-scroll scroll-hidden">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Sélectionnez le nouveau statut de la mission pour le mettre à jour.
                        </DialogDescription>
                    </DialogHeader>
                    <form onSubmit={formik.handleSubmit} className="mt-4 px-2 flex flex-col gap-8">
                        ...
                        <DialogFooter className="flex items-center justify-end">
                            ...
                            <CustomButton
                                type="submit"
                                disabled={isPending || !formik.isValid || formik.values.status === mission.status}
