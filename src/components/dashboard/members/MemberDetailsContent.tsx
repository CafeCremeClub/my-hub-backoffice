...
const MemberDetailsContent = ({ id }: MemberDetailsContentProps) => {
  ...
  if (isError || !data) {
    return (
      <ErrorBox message="Une erreur est survenue lors du chargement des details du membre." />
    );
  }
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm font-medium text-[#1B55F5]">
                    {data.email}
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <div className="text-lg font-bold text-[#1B55F5]">
                    {data.tjm}€
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white rounded-[0.75rem] border border-[#D0D5DD] p-6">
            ...
            <div className="flex flex-wrap gap-2">
              {data.desiredJobs.length > 0 ? (
                ...
                <p className="text-[#667085] text-sm">
                  Aucun poste recherché renseigné
                </p>
              )}
            </div>
          </div>
