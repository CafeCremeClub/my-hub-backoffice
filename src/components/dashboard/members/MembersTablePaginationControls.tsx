...
interface MembersTablePaginationControlsProps {
    currentPage: number;
    totalCount: number;
    perPage: number;
...
const MembersTablePaginationControls = ({
                                            currentPage,
                                            totalCount,
                                            perPage,
                                            onPageChange
                                        }: MembersTablePaginationControlsProps) => {
...
export default MembersTablePaginationControls;