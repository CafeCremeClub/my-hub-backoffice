...
interface WhiteListTablePaginationControlsProps {
    currentPage: number;
    totalCount: number;
    perPage: number;
...
const WhiteListTablePaginationControls = ({
                                            currentPage,
                                            totalCount,
                                            perPage,
                                            onPageChange
                                        }: WhiteListTablePaginationControlsProps) => {
...
export default WhiteListTablePaginationControls;